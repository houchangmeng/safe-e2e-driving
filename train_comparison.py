...
from slac.algo import LatentPolicySafetyCriticSlac, SlacAlgorithm, LatentPolicySlac
...
params = {
    ...
    'max_ego_spawn_times': 12, # maximum times to spawn ego vehicle
    ...
    'enable_display': False # enable display manager
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument("--initial_collection_steps", type=int, default=5 * 10 **3, help="Number of initial collection steps")#3
    ...
    parser.add_argument("--play", type=bool,default=True, help="Evaluate the agent.")
